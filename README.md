...
launch from the command line:
    ...
    $ lein run -m callcongressnow.web
...
get the app created:
    ...
    $ heroku apps:create callcongressnow
    Creating callcongressnow... done, stack is cedar
    http://callcongressnow.herokuapp.com/ | git@heroku.com:callcongressnow.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://callcongressnow.herokuapp.com deployed to Heroku

    To git@heroku.com:callcongressnow.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://callcongressnow.herokuap.com
    ["Hello" :from Heroku]
